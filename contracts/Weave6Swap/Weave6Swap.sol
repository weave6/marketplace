...
contract Weave6Swap is SpecialTransferHelper, Ownable, ReentrancyGuard {
    ...
    function _trade(
        ...
        for (uint256 i = 0; i < _tradeDetails.length; i++) {
            ...
            // execute trade
            if (_proxy == 0x7Be8076f4EA4A4AD08075C2508e481d6C946D12b || _proxy == 0x7f268357A8c2552623316e2562D90e642bB538E5) { //opensea 直接调用
